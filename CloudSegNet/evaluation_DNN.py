...
# Path to the folder where you want to save the segmentation results
result_folder = './results/segmentation_results/'
...
for sample_iter in range(no_of_testing_images):
    ...
    save_result_name = result_folder + f'result_{sample_iter}.png'
    plt.imsave(save_result_name, image_map, cmap='gray')
